...
#include <dust2/discrete/filter.hpp>
...
template <typename T>
cpp11::sexp dust2_discrete_filter_update_pars(cpp11::sexp ptr,
                                              cpp11::list r_pars,
                                              bool grouped) {
  auto *obj =
...
template <typename T>
cpp11::sexp dust2_discrete_filter_run(cpp11::sexp ptr, cpp11::sexp r_initial,
