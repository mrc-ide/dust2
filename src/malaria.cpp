...
SEXP dust2_system_malaria_internals(cpp11::sexp ptr, bool include_coefficients) {
  return dust2::r::dust2_system_internals<dust2::dust_continuous<malaria>>(ptr, include_coefficients);
}
[[cpp11::register]]
...
SEXP dust2_system_malaria_set_state(cpp11::sexp ptr, cpp11::sexp r_state, cpp11::sexp index_state, cpp11::sexp index_particle, cpp11::sexp index_group, bool recycle_particle, bool recycle_group) {
  return dust2::r::dust2_system_set_state<dust2::dust_continuous<malaria>>(ptr, r_state, index_state, index_particle, index_group, recycle_particle, recycle_group);
}
...
SEXP dust2_unfilter_malaria_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads, cpp11::sexp r_index_state) {
  return dust2::r::dust2_continuous_unfilter_alloc<malaria>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads, r_index_state);
}
...
SEXP dust2_filter_malaria_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads, cpp11::sexp r_index_state, cpp11::sexp r_seed) {
  return dust2::r::dust2_continuous_filter_alloc<malaria>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads, r_index_state, r_seed);
}
[[cpp11::register]]
...
SEXP dust2_unfilter_malaria_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_history, bool adjoint, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_run<dust2::dust_continuous<malaria>>(ptr, r_initial, save_history, adjoint, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malaria_last_history(cpp11::sexp ptr, cpp11::sexp r_index_group, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_history<dust2::dust_continuous<malaria>>(ptr, r_index_group, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malaria_last_state(cpp11::sexp ptr, cpp11::sexp r_index_group, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_state<dust2::dust_continuous<malaria>>(ptr, r_index_group, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malaria_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_history, bool adjoint, cpp11::sexp index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_run<dust2::dust_continuous<malaria>>(ptr, r_initial, save_history, adjoint, index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malaria_last_history(cpp11::sexp ptr, cpp11::sexp r_index_group, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_history<dust2::dust_continuous<malaria>>(ptr, r_index_group, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malaria_last_state(cpp11::sexp ptr, cpp11::sexp r_index_group, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_state<dust2::dust_continuous<malaria>>(ptr, r_index_group, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
