...
malaria <- structure(
  ...
  path = NULL,
  parameters = data.frame(
    name = c("a", "n_rates", "r", "tau", "initial_Ih", "initial_Iv", "initial_Sv", "beta_volatility"),
    type = c("real_type", "int", "real_type", "real_type", "real_type", "real_type", "real_type", "real_type"),
    constant = c(FALSE, TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE),
...
sir <- structure(
  ...
  properties = list(
    ...
    has_adjoint = TRUE),
  default_dt = 1)
sirode_adjoint <- structure(
  function() get("sirode_adjoint"),
  class = "dust_system_generator",
  name = "sirode_adjoint",
  package = "dust2",
  path = NULL,
