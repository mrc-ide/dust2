...
# Source: https://github.com/reside-ic/reside.utils/blob/prototype/R/standalone-utils-assert.R
# Generated by: usethis::use_standalone("reside-ic/reside.utils", "utils-assert", ref = "prototype")
# ----------------------------------------------------------------------
#
# ---
