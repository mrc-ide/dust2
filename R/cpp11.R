...
dust2_discrete_sir_alloc <- function(r_pars, r_time, r_dt, r_n_particles, r_n_groups, r_seed, r_deterministic) {
  .Call(`_dust2_dust2_discrete_sir_alloc`, r_pars, r_time, r_dt, r_n_particles, r_n_groups, r_seed, r_deterministic)
}

dust2_discrete_sir_run_steps <- function(ptr, r_n_steps) {
...
dust2_discrete_sir_unfilter_run <- function(ptr, r_initial, save_history, adjoint, grouped) {
  .Call(`_dust2_dust2_discrete_sir_unfilter_run`, ptr, r_initial, save_history, adjoint, grouped)
}

dust2_discrete_sir_unfilter_last_history <- function(ptr, grouped) {
  .Call(`_dust2_dust2_discrete_sir_unfilter_last_history`, ptr, grouped)
}

dust2_discrete_sir_filter_alloc <- function(r_pars, r_time_start, r_time, r_dt, r_data, r_n_particles, r_n_groups, r_index, r_seed) {
...
dust2_discrete_sir_filter_last_history <- function(ptr, grouped) {
  .Call(`_dust2_dust2_discrete_sir_filter_last_history`, ptr, grouped)
}

dust2_discrete_sir_filter_rng_state <- function(ptr) {
  .Call(`_dust2_dust2_discrete_sir_filter_rng_state`, ptr)
}

dust2_discrete_sir_filter_set_rng_state <- function(ptr, r_rng_state) {
  .Call(`_dust2_dust2_discrete_sir_filter_set_rng_state`, ptr, r_rng_state)
}

dust2_discrete_sir_unfilter_last_gradient <- function(ptr, grouped) {
  .Call(`_dust2_dust2_discrete_sir_unfilter_last_gradient`, ptr, grouped)
}
...
dust2_discrete_walk_alloc <- function(r_pars, r_time, r_dt, r_n_particles, r_n_groups, r_seed, r_deterministic) {
  .Call(`_dust2_dust2_discrete_walk_alloc`, r_pars, r_time, r_dt, r_n_particles, r_n_groups, r_seed, r_deterministic)
}

dust2_discrete_walk_run_steps <- function(ptr, r_n_steps) {
