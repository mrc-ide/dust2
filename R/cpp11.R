...
dust2_system_logistic_alloc <- function(r_pars, r_time, r_control, r_n_particles, r_n_groups, r_seed, r_deterministic) {
  .Call(`_dust2_dust2_system_logistic_alloc`, r_pars, r_time, r_control, r_n_particles, r_n_groups, r_seed, r_deterministic)
}
